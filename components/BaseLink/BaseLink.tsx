...
import StyledLink from "./BaseLink.css";
...
function BaseLink({ url, text, variants, whileHover, whileTap }: LinkProps): JSX.Element {
  return (
    <Link href={url} locale="en" passHref>
      <motion.a whileHover={whileHover} whileTap={whileTap} variants={variants} className={StyledLink}>
        {text}
      </motion.a>
    </Link>
  );
